...
export const CreateProduct: React.FC<CreateProductProps> = ({ onCancel, onSave, user }) => {
  ...
  return (
    <div className="p-8 max-w-[800px] mx-auto mt-16 pb-20">
      <header className="mb-8">
        ...
        <h2 className="text-3xl font-black text-[#091426] tracking-tight">Agregar Nuevo Producto</h2>
        <p className="text-slate-500 font-medium mt-1">Ingresa las especificaciones técnicas y de stock para el nuevo artículo.</p>
      </header>
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 flex items-center gap-2">
                  <Database className="w-3 h-3 text-slate-400" /> Stock Inicial
                </label>
                <input 
                  type="number" 
                  value={stock}
                  ...
                  <div className="w-full md:w-48 aspect-square rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 flex items-center justify-center overflow-hidden group hover:border-[#091426] transition-all relative">
                    {previewUrl ? (
                      ...
                      <div className="text-center p-4">
                        ...
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest group-hover:text-[#091426]">Subir Foto</p>
                      </div>
                    )}
                    <input 
                      type="file" 
